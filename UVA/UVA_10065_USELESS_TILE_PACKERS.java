...
public class UVA_10065_USELESS_TILE_PACKERS {
	...
	public static void main(String[] args) throws Exception{
		...
		while(true)
		{
			...
			Polygon concave = new Polygon(g);
			
			double areaConcave = concave.area(); 
			
			Polygon convex = Polygon.convexHull(g);
			
			double percentage =  (((convex.area()- areaConcave)/convex.area())*100.0);
			
			out.printf("Tile #%d\n",cases++);
			out.printf("Wasted Space = %.2f ",percentage);
			out.print("%\n\n");
		}
